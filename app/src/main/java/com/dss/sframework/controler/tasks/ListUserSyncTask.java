...
public class ListUserSyncTask extends AsyncTask<Void, Integer, Boolean> {
...
//    ProgressDialog progress;
    ...
    public ListUserSyncTask(int idUsuario, UpdateDelegate delegate) {
...
//        progress.dismiss();
    ...
    public String makeConnection() throws IOException {
        String url = ConstantUrl.URL_WEBSERVICE + ConstantUrl.METHOD_LIST_USER;
