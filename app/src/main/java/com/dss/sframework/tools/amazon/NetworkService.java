...
public class NetworkService extends IntentService {
    ...
    public void onCreate() {
        super.onCreate();
        System.out.println("NetworkService.onCreate");
        mTransferManager = new TransferManager(AmazonUtil.getCredProvider(this));
    }

    @Override
    public void onHandleIntent(Intent intent) {
        System.out.println("NetworkService.onHandleIntent");
...
//        System.out.println("NetworkService.upload");
