...
import com.dss.sframework.tools.amazon.models.TransferModel;
import com.dss.sframework.tools.amazon.models.UploadModel;
...
public class TransferController {
    ...
    public TransferController(Context context) {
        ...
        this.mTransferManager = new TransferManager(AmazonUtil.getCredProvider(context));
    }
...
//    public void upload(Uri uri) {
    public void upload(Enums.MEDIA_TYPE mediaType, File file, String extension, String callerFragmentTag) {
        UploadModel model = new UploadModel(context, mTransferManager, mediaType, file, extension, callerFragmentTag);
